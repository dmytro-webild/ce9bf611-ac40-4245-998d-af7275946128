...
export const metadata: Metadata = {
  title: "SB Solutions | Credit Repair, Building & Funding Consulting",
  description: "Expert credit repair and funding consulting services. Improve your credit score, build stronger credit profiles, and unlock personal and business funding opportunities with SB Solutions.",
  keywords: "credit repair, credit building, funding consulting, credit score improvement, financial consulting, business funding, personal funding",
  metadataBase: new URL("https://sbsolutions.com"),
  alternates: {
    canonical: "https://sbsolutions.com",
  },
  openGraph: {
    title: "SB Solutions - Transform Your Financial Future",
    description: "Professional credit repair and funding consulting to help you achieve financial goals.",
    siteName: "SB Solutions",
    type: "website",
    images: [
      {
        url: "http://img.b2bpic.net/free-photo/smart-businesswoman-explaining-chart_1139-298.jpg",
        alt: "SB Solutions - Credit Repair & Funding Consulting",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "SB Solutions - Credit Repair & Funding Consulting",
    description: "Transform your financial future with expert credit repair and funding consulting services.",
    images: ["http://img.b2bpic.net/free-photo/smart-businesswoman-explaining-chart_1139-298.jpg"],
  },
  robots: {
    index: true,
    follow: true,
